# Usage:   postBestEval.bat <experiment directory> <log prefix> <run type> <run number> <number of trials per individual>
# Example: postBestEval.bat onelifeconflict OneLifeConflict OneModule 0 5
