...
cd ..
cd ..
C:\Users\raffertyt\AppData\Local\anaconda3\python.exe 3DMAPElitesArchivePlotAnimator.py minecraftinteger/MEObserverIntegerPistonOrientation1/MinecraftInteger-MEObserverIntegerPistonOrientation1_MAPElites_log.txt "MinecraftInteger-MEObserverIntegerPistonOrientation1_MAPElites" "NorthSouthPistonCountFitness" 5 "UpDownPistonCountFitness" 5 "EastWestPistonCountFitness" 5 2 %1 %2 %3