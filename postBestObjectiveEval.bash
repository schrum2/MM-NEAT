# Usage:   postBestObjectiveEval.bat <experiment directory> <log prefix> <run type> <run number> <number of trials per individual>
# Example: postBestObjectiveEval.bat onelifeconflict OneLifeConflict OneModule 0 5
