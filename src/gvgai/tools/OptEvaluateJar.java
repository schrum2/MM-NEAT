...
import gvgai.core.optimization.ucbOptimization.UCBEvoEquation;
import gvgai.core.optimization.ucbOptimization.UCBOptimization;
...
public class OptEvaluateJar {
	...
	for (int i = 0; i < engineParameters.length; i++) {
		...
		break;
	    case "safetymargin":
		gvgai.tracks.singlePlayer.tools.ucbOptimizerAgent.Agent.safetyMargin = Integer.parseInt(value);
		break;
	    case "scoretowin":
