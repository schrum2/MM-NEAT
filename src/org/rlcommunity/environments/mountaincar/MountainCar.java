...
public class MountainCar extends RLGlueEnvironment
	...
	public TaskSpec makeTaskSpec() {
		...
		theTaskSpecObject
				.setExtra("EnvName:Mountain-Car Revision:" + this.getClass().getPackage().getImplementationVersion());
	...
	public String env_message(String theMessage) {
		...
		System.err.println(
				"We need some code written in Env Message for MountainCar.. unknown request received: " + theMessage);
		Thread.dumpStack();
		return null;
	}
