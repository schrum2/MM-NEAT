...
/**
 * This is a JUnit test for the core methods of the Resumable Random class, getSeed which 
 * gets the current seed of the Random, and hardSetSeed which sets the seed to a new value.
 * 
 * @author gillespl
 *
 */
