...
/**
 * Compute value for a given percentile in an array of doubles:
 * For example, the 23rd percentile is the value that 23% of the
 * values in the double array are less than.
 * 
 * @author Jacob Schrum
 */
