...
public class CartesianGeometricUtilitiesTest {
	...
	public void testShortestDistanceToLineSegment() {
		...
		assertEquals(CartesianGeometricUtilities.shortestDistanceToLineSegment(point, topOfSegment, bottomOfSegment), 1.0, DOUBLE_THRESHOLD);
		assertEquals(CartesianGeometricUtilities.shortestDistanceToLineSegment(otherPoint, topOfSegment, bottomOfSegment), 1.1180, DOUBLE_THRESHOLD);
	}
	...
	public void testSourceHeadingTowardsTarget() {
		...
		assertFalse(CartesianGeometricUtilities.sourceHeadingTowardsTarget(-Math.PI/4, source, target, DOUBLE_THRESHOLD));
	}
	...
	public void  testSignedAngleFromSourceHeadingToTarget() {
		...
		assertEquals(CartesianGeometricUtilities.signedAngleFromSourceHeadingToTarget(source, target, Math.PI/4), -Math.PI/4, DOUBLE_THRESHOLD);
	}
