...
public class DeleteLinkMutation extends TWEANNMutation {
	...
	/**
	 * Runs a test procedure to verify correct functioning of the mutation. This
	 * should be made into a proper JUnit Test
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		Parameters.initializeParameterCollections(
				new String[] { "io:false", "netio:false", "recurrency:false", "mmdRate:0.1", "deleteLinkRate:0.3" });
		// MONE.loadClasses();
