...
public abstract class ModuleMutation extends TWEANNMutation {
	...
	public void mutate(Genotype<TWEANN> genotype) {
		if (CommonConstants.weakenBeforeModeMutation) {// weakens modules if
														// needed
		...
		if (CommonConstants.hierarchicalMultitask) {
			...
			int[] newmoduleAssociations = new int[originalModules + 1]; // One
																		// module
																		// added
			...
			newmoduleAssociations[originalModules] = RandomNumbers.randomGenerator.nextInt(hierarchicalmodules); // Assign
																													// to
																													// random
																													// multitask
																													// module
