...
public class TWEANNGenotype implements NetworkGenotype<TWEANN> {
	...
	public class LinkGene extends Gene {
		 ...
		 *            = innovation of node of origin
		 * @param targetInnovation
		 *            = innovation of node target
		 * @param weight
		 *            = weight of new link
		 * @param innovation
		 *            = innovation number of link gene itself
		 * @param recurrent
		 *            = true if link is recurrent
		 */
		public LinkGene(long sourceInnovation, long targetInnovation, double weight, long innovation,
				boolean recurrent) {
		 ...
		 *
		 * @param sourceInnovation
		 *            = innovation of node of origin @param targetInnovation =
		 *            innovation of node target @param weights = synaptic
		 *            weights @param innovation = innovation number of link gene
		 *            itself @param recurrent = true if link is recurrent @param
		 *            frozen = true if link cannot be changed
		 * @param targetInnovation
		 *            Innovation number of node that the link points to
		 * @param weight
		 *            Synaptic weight
		 * @param innovation
		 *            Innovation number of link gene
		 * @param recurrent
		 *            Whether the link is considered recurrent
		 * @param frozen
		 *            Whether the link is immune to modifications by mutation
		 */
		 ...
		 *            innovation of node target @param weights = synaptic
		 *            weights @param innovation = innovation number of link gene
		 *            itself @param active = whether the link is present in
		 *            phenotype network @param recurrent = true if link is
		 *            recurrent @param frozen = true if this link can no longer
		 *            be changed by mutation
		 * @param targetInnovation
		 *            Innovation number of node that the link points to
		 * @param weight
		 *            Synaptic weight
		 ...
		 *            Innovation number of link gene
		 * @param active
		 *            Whether link is expressed in phenotype
		 * @param recurrent
		 *            Whether the link is considered recurrent
		 * @param frozen
		 *            Whether the link is immune to modifications by mutation
	 ...
	 *
	 * @param nodes
	 *            List of node genes in genotype (must obey order rules)
	 * @param links
	 *            List of link genes in genotype
	 * @param neuronsPerModule
	 *            Number of policy neurons per output module
	 * @param standardMultitask
	 *            Whether this is a multitask network
	 * @param hierarchicalMultitask
	 *            Whether this is a hierarchical multitask network
	 * @param archetypeIndex
	 *            Index of archetype to compare against for mutation/crossover
	 *            alignments
	 */
	 ...
	 *
	 * @param recurrent
	 *            Whether only recurrent links are being counted (vs only
	 *            non-recurrent)
	 ...
	 *
	 * @param tweann
	 *            The network to make a genotype for
	 */
	 ...
	 *
	 * @param numIn
	 *            = actual number of input sensors
	 * @param numOut
	 *            = number of actuators (in multitask case, #actuations times
	 *            num tasks. For module mutation, # of policy neurons per
	 *            module)
	 * @param archetypeIndex
	 *            = which archetype to reference for crossover
	 */
	 ...
	 *            = whether initial network is sparsely connected
	 * @param ftype
	 *            = activation function to use on neurons
	 * @param numModules
	 *            = number of MULTITASK modules (does not apply for multiple
	 ...
	 *
	 * @param ftype
	 *            activation function on each output neuron
	 */
	 ...
	 *
	 * @param randomSources
	 *            true if new mode is connected to random sources. false if mode
	 *            is connected to old mode.
	 * @param numLinks
	 *            = number of links going in to each new output neuron return
	 ...
	 *
	 * @param index
	 *            Index of link in "links" to delete
	 * @return The link deleted
	 */
	 ...
	 *
	 * @param nodeNum
	 *            = index in "nodes" of neuron to delete (must be an output
	 *            node)
	 */
	 ...
	 * @param rate
	 *            = Chance for each individual link mutation
	 */
	 ...
	 *
	 * @param linkIndex
	 *            = index of link in links. Cannot be frozen
	 * @param delta
	 ...
	 *
	 * @param sourceInnovation
	 *            = linkInnovations of nodeInnovation node
	 * @param targetInnovation
	 ...
	 *
	 * @param source:
	 *            the starting node innovation number
	 * @param weight:
	 ...
	 *
	 * @param includeInputs
	 *            = true if input neurons can potentially be selected
	 ...
	 *
	 * @param ftype
	 *            activation function of genotype
	 */
	 ...
	 *
	 * @param ftype
	 *            = activation function type of new node
	 * @param newNodeInnovation
	 *            = linkInnovations number of new node
	 * @param sourceInnovation
	 ...
	 * @param fromLinkInnovation
	 *            = new linkInnovations number for newNode between new node and
	 *            sourceInnovation
	 */
	 ...
	 *
	 * @param portion
	 *            location in genotype of portion ti be weakened
	 */
	 ...
	 *            = module to weaken
	 * @param portion
	 *            should be between 0 and 1: Fraction to reduce weight by
	 */
	 ...
	 *            = list of neurons that will link to the new one
	 * @param weights
	 *            = weights for the synapses linking the sourceInnovations to
	 *            this new node
	 * @param linkInnovations
	 *            = innovation numbers for each of the new synapses
	 ...
	 *
	 * @param first
	 *            module associations of the network this one is replacing.
	 * @param second
	 *            module associations of the network this one was crossed with.
	 */
	 ...
	 *
	 * @param m
	 *            first TWEANNGenotype to be compared
	 * @param o
	 *            second TWEANNGenotype to be compared
	 ...
	 *
	 * @param numInputs:
	 *            number of inputs from network in which to randomly place
	 *            neuron
	 */
	 ...
	 *
	 * @param moduleIndex
	 *            = index of mode to give preference neuron
	 */
	 ...
	 *
	 * @param neuronIndex
	 *            = index in nodes of neuron to duplicate
	 */
	 ...
	 *
	 * @param nodeInnovation
	 *            the innovation number to be frozen
	 * @param visited
	 *            a hash set of innovation numbers that have been visited
	 */
	 ...
	 *
	 * @param linkedGene
	 *            ArrayList of link genes to be sorted
	 */
	 ...
	 *
	 * @param o
	 *            An object that should be a TWEANNGenotype
