...
public interface Genotype<T> {
     ...
     * Mutate the genotype.
     * 
     * This operation can probabilistically call a variety
     * of other specific mutation operators. Calling this method
     * does not guarantee that the genotype will be modified.
     */
    public void mutate();

    /**
     * Cross this genotype with another genotype g to create up to
     * two new offspring. One of the offspring is returned. Additionally,
     * this genotype itself may be modified, thus representing another offspring,
     * but this would only be appropriate if crossover is performed on a copy
     ...
     * instance. This method is typically used at the beginning of evolution
