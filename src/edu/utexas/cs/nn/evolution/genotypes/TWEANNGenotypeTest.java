...
public class TWEANNGenotypeTest {
	...
	public void test_Equals() {
		Parameters.initializeParameterCollections(new String[]{"io:false", "netio:false", "allowMultipleFunctions:true", "recurrency:false", "mmdRate:0.1"});
	    MMNEAT.loadClasses();
	...
	public void test_sameStructure() {
		...
		System.out.println("-------");
		System.out.println(Arrays.toString(tg1Copy.nodes.toArray()));
		System.out.println(Arrays.toString(tg1.nodes.toArray()));
		System.out.println("-------");
