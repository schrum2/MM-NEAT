...
public class GenotypePool<T extends Network> {
	...
	// Type must be raw so that different pools can contain different types of
	// genotypes.
	...
	/**
	 * Treat all .xml files in a particular directory as genotypes, and use them
	 * to create the genotype pool.
	 * 
	 * @param directory
	 *            Directory containing .xml genotypes
	 */
	...
	/**
	 * Retrieve actual genotype using filename stored in pool at particular
	 * index
	 * 
	 * @param x
	 *            index in genotype pool of desired filename
