 ...
 * 
 * @author Jacob Schrum
 * @param <T> The evolved phenotype, which must be a neural network
 */
public interface NetworkGenotype<T extends Network> extends Genotype<T>{
    ...
    /**
     * Assign the module usage of a network phenotype back to the
     * genotype which spawned it for logging purposes.
     * @param usage Array where each index corresponds to a module
     * and contains the number of times that module was used by the
     * network phenotype.
     */
