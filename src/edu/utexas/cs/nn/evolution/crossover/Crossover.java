 ...
 * @author Jacob Schrum 
 * 
 * This is an abstract class that takes in the genotypes of
 * two agents, crosses them over, then returns the final product.
 * @param <T> Phenotype of genotypes being crossed over
 */
public abstract class Crossover<T> {

    /**
     * There are two offspring from crossover.
     * One is directly returned. The other is generated by
     * modifying the genotype sent in, meaning that this 
     * parameter should always be a copy of the parent genotype
     * being sent in.
     * 
