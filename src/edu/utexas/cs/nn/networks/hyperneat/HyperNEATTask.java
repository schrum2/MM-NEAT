...
public interface HyperNEATTask {
	...
	/**
	 * Given information about the input substrate layers, fill out a linear
	 * double array with the inputs the controller network will receive.
	 *
	 * @param inputSubstrates
	 *            List of ONLY input substrates, in standard order
