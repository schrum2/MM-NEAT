...
public class SpeedTest {
	...
	public void setUp() throws Exception {
		Parameters.initializeParameterCollections(new String[] { "io:false", "allowMultipleFunctions:true", "netio:false", "recurrency:false", "mmdRate:0.1", "hyperNEAT:true", "task:edu.utexas.cs.nn.networks.hyperneat.HyperNEATSpeedTask", "ftype:1"});
		MMNEAT.loadClasses();
	...
	//	System.out.println("tweann:" + tweann.toString());
		//System.out.println("mlp: " + mlp.toString());
