 ...
 * This class simply puts random number outputs into the prey's movements
 */
public class RandomPreyController extends TorusPredPreyController {
	 ...
	 * movements in the prey
	 */
    @Override
    public int[] getAction(TorusAgent me, TorusWorld world, TorusAgent[] preds, TorusAgent[] prey) {
        return PREY_ACTIONS[RandomNumbers.randomGenerator.nextInt(PREY_ACTIONS.length)];
    }
