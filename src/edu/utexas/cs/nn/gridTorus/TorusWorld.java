...
public class TorusWorld {
     ...
     * @param p position of the agent (x or y)
     * @param max maximum position in the grid world (will be xDim or yDim)
     * @return the new position of the agent after bounding it in a wrapped manner
     */
     ...
     * @param x the agent's position on the x-axis
     * @return the new position of the agent after bounding it in a wrapped manner
     */
     ...
     * @param y the agent's position on the y-axis
     * @return the new position of the agent after bounding it in a wrapped manner
     */
    ...
    /**
     * find the shortest distance between the two given positions
     * this could be simply the distance between the two on the axis on the grid
     * or the distance from each other by going off the edge and wrapping,
     * whichever is closer 
     * @param p1 position of first agent (x or y)
     * @param p2 position of second agent (x or y)
     * @param max boundary of gridWorld (maximum possible position/edge of world), xDim or yDim
     ...
     * @param x1 agent 1 x position
     * @param x2 agent 2 x position
     * @return the shortest distance between the agents, either wrapping or plain distance
     */
     ...
     * @param y1 agent 1 y position
     * @param y2 agent 2 y position
     * @return the shortest distance between the agents, either wrapping or plain distance
     */
     ...
     *
     * @param y1 y-coord of agent
     * @param y2 y-coord of relative target
    ...
    /**
     * Shortest offset from position p1 to position p2 (used on either x-axis or y-axis)
     * @param p1 position x or y of agent 1
     * @param p2 position x or y of agent 2
     * @param max xDim or yDim, depending on which axis is being used
    ...
    /**
     * find a random cell within the grid world that does not have an agent in it
     * @param agents the array of all agents
