...
public class NearestOpponentDistanceBlock implements UT2004SensorBlock {
    ...
    public int incorporateSensors(UT2004BotModuleController bot, int in, double[] inputs) {
        ...
        double distance = (botLocation == null || opponentLocation == null) ? MAX_DISTANCE : botLocation.getDistance(opponentLocation);
        double distance2D = (botLocation == null || opponentLocation == null) ? MAX_DISTANCE : botLocation.getDistance2D(opponentLocation);
