...
public class AutoRayTraceSensorBlock implements UT2004SensorBlock {
    ...
    public void prepareBlock(final UT2004BotModuleController bot) {
         ...
         */
        //bot.getRaycasting().createRay("DUMMY", new Vector3d(0, 0, 0), 0, false, false, false);
    ...
    public void addRayToAutoTrace(UT2004BotModuleController bot, int id, Vector3d v, int rayLength, boolean bFastTrace, boolean bTraceActors) {
