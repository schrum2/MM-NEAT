...
public class NetworkController<T extends Network> extends Organism<T> implements BotController {
    ...
    public NetworkController(Genotype<T> g, UT2004SensorModel sensorModel, UT2004OutputInterpretation outputModel, UT2004WeaponManager weaponManager) {
        super(g);
    ...
    public BotAction control(UT2004BotModuleController bot) {
        ...
        //action = new OpponentRelativeMovementAction(opponent, 1, 0, true, false);
