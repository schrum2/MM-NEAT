...
public class UT2004OneVsNativeBotsDeathMatchTask<T extends Network> extends UT2004Task<T> {
    ...
    public static void main(String[] args) {
        Parameters.initializeParameterCollections(new String[]{"utDrive:F", "trials:2", "io:false", "task:edu.utexas.cs.nn.tasks.ut2004.UT2004OneVsNativeBotsDeathMatchTask"});
        MMNEAT.loadClasses();
        UT2004Task utTask = (UT2004Task) MMNEAT.task;
        new UT2004OneVsNativeBotsDeathMatchTask<TWEANN>("DM-TrainingDay", new int[]{3, 4, 5}, 5, 1).evaluate(new TWEANNGenotype(utTask.sensorModel.numberOfSensors(), utTask.outputModel.numberOfOutputs(), 0));
    }
}
