...
public class TorusPreyByIndexSensorBlock implements TorusPredPreySensorBlock {
	...
	@Override
	/**
	 * @return the sensor inputs to prey simply by their indices. The sensor inputs are the X and Y offsets from 
	 * this agent to each prey
	 */
	 ...
	 * The sensor labels for this class will be the list of Prey being sensed (by index)
