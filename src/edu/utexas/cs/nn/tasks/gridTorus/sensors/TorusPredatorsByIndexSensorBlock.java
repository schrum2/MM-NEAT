...
/**
 * finds the sensor inputs for the predators by index. The inputs will be the X and Y
 * offsets to each predator
 * @author rollinsa
 *
 */
public class TorusPredatorsByIndexSensorBlock implements TorusPredPreySensorBlock {
	...
	@Override
	/**
	 * @return the sensor inputs for the predators by index. The inputs will be the X and Y
	 * offsets to each predator from this agent.
	 */
	 ...
	 * The sensor labels for this class will be the list of Predators being sensed (by index)
