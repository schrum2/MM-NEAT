...
public class NNTorusPredPreyController extends TorusPredPreyController {
	 ...
	 * The sensor labels will depend upon which type of agent this is (which agent is being evolved)
	 * and if the agent is allowed to senseTeammates in addition to enemies.
