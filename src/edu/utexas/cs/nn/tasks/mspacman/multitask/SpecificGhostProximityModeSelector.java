...
/**
 * A Mode selector for a single specified ghost which selects between 2 modes based on the following:
 * 0) The specific ghost is close
 * 1) The specific ghost is far
 * @author Jacob Schrum
 */
public class SpecificGhostProximityModeSelector extends MsPacManModeSelector {
    ...
    /**
     * constructs this mode selector based off of the specified ghost and crowdedGhostDistance
     * @param ghostIndex
     */
     ...
     * @return an int array holding the score for if the specific ghost is close in the first index and the score
     * for if the specific ghost is far in the second index
     */
