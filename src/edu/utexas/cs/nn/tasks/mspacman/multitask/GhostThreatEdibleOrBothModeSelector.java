 ...
 * 0) The ghosts are all edible or are in the lair 
 * 1) The ghosts are all a threat or are in the lair 
 * 2) A mix. So the ghosts are either a threat or in the lair or edible or in the lair
 * @author Jacob Schrum
 */
public class GhostThreatEdibleOrBothModeSelector extends MsPacManModeSelector {
     ...
     * @return an int array holding the score for if none of the ghosts are threats in the first index and the score
     * for if all of the ghosts are threats in the second index and the score for if some of the ghosts are threats or in lair
     * and some are not threats or in lair in the third index
     */
