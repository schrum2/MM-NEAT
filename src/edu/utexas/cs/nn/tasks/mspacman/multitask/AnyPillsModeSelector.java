...
public class AnyPillsModeSelector extends MsPacManModeSelector {
    ...
    /**
     * sets the game mode based on if there are any pills or not
     * 0 if there are some pills
     * 1 if there are no pills
     * @return mode
     */
    public int mode() {
     ...
     * @return an int array holding the score for if there are some pills in the first index and the score
     * for if there are no pills in the second index
     */
