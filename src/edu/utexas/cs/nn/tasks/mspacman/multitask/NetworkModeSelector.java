...
public class NetworkModeSelector<T extends Network> extends MsPacManModeSelector {
    ...
    /**
     * A Mode selector which selects modes from a specific number of modes based on the number
     * of outputs of the network by finding the maximum of the outputs
     * @return mode
     */
    public int mode() {
    ...
    /**
     * returns the number of Modes for this mode selector, which is dependent upon
     ...
     * @return an int array holding the associated scores. One index per mode, which 
     * is based off of the number of network outputs
     */
