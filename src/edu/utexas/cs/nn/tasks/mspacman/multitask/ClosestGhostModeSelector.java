...
/**
 * A Mode selector which selects modes based on if the closest ghost is a threat or is edible
 * @author Jacob Schrum
 */
public class ClosestGhostModeSelector extends MsPacManModeSelector {
     ...
     * 0 if the closest ghost is a threat
     * 1 if the closest ghost is edible
     * @return mode
     */
    public int mode() {
     ...
     * @return an int array holding the score for if the closest ghost is a threat in the first index and the score
     * for if the closest ghost is edible in the second index
     */
