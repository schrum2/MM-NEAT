 ...
 * before pacman can possibly reach it, the sensor does not report this. In
 * other words, the sensor says it is safe to attack the edible ghost, even
 * though it may be guaranteed that the ghost will become a deadly threat before
 * eaten.
 * 
 * @author Jacob Schrum
 */
public class VariableDirectionCloserToEdibleGhostThanThreatGhostBlock
