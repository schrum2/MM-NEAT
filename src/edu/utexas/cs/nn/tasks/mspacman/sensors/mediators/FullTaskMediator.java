...
public class FullTaskMediator extends UnionInputOutputMediator {
	...
	// }
	//
	// public FullTaskMediator(boolean absolute, boolean prox, boolean diff,
	// boolean sim, boolean cluster, boolean nearestDir, boolean nearestDis,
	// boolean farthestDis, boolean specific, boolean specialPowerPill, boolean
	// ghostTimes, boolean lairDis, boolean veryClose, boolean mazeTime, boolean
	// incoming) {
	// super(Arrays.asList(new BlockLoadedInputOutputMediator[]{
	// new GhostTaskMediator(true, absolute, prox, diff, sim, cluster,
	// nearestDir, nearestDis, farthestDis, specific, specialPowerPill,
	// ghostTimes, lairDis, veryClose, mazeTime, incoming),
	// new PillTaskMediator(absolute, prox, diff, sim, nearestDir, nearestDis,
	// farthestDis, lairDis, veryClose, mazeTime)}));
	// }
}
