 ...
 * beginning, I would have set up the sensor blocks differently, but since I
 * didn't, I have to find a way to duplicate some similar sensors without
 ...
 * for aspects of the world that are not dependent on the position of the
 * sensing agent.
 * 
 * @author Jacob Schrum
 */
public class GhostReuseMsPacManSensorBlock extends GhostSensorBlock {
	...
	public int incorporateSensors(double[] inputs, int in, GameFacade gf, int ghostIndex) {
		return block.incorporateSensors(inputs, in, gf, 0); // Direction should
															// be meaningless
	}
