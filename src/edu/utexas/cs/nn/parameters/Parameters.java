...
public class Parameters {
	...
	public final void fillDefaults() {
		...
		integerOptions.add("HNTProcessDepth", 1, "The number of processing layers in a HNT substrate");
		integerOptions.add("HNTProcessWidth", 1, "The number of adjacent processing substrates per layer in a HNT substrate");
