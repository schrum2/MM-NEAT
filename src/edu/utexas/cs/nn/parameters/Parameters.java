...
import edu.utexas.cs.nn.tasks.microrts.evaluation.NNComplexEvaluationFunction;
...
public class Parameters {
	...
	public final void fillDefaults() {
		...
		integerOptions.add("defaultPitch", 10, "Default pitch value for 3DObjectbreeder vertical rotation");
		// Long parameters
