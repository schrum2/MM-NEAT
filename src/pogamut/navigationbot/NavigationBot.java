...
/**
 * Example of Simple Pogamut bot, that randomly walks around the map. <p><p> Bot
 * is able to handle movers as well as teleporters. <p><p> It also implements
 * player-following, that is, if it sees a player, it will start to navigate to
 * it.
 *
    ...
    private void talkTo(Player player) {
        ...
        switch (talking) {
            ...
            case 4:
                ...
                break;
            case 10:
                body.getCommunication().sendGlobalTextMessage("I'm NavigationBot made to fool around and test Pogamut's navigation stuff!");
                break;
            case 18:
