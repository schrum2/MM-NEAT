...
public class MMNEAT {
	...
	public static double[] getLowerBounds() {
		...
		else if (task instanceof FunctionOptimizationTask) return ArrayUtil.doubleSpecified(Parameters.parameters.integerParameter("foVectorLength"), Parameters.parameters.doubleParameter("foLowerBounds")); // default to -Infinity
	...
	public static double[] getUpperBounds() {
		...
		else if (task instanceof FunctionOptimizationTask) return ArrayUtil.doubleSpecified(Parameters.parameters.integerParameter("foVectorLength"), Parameters.parameters.doubleParameter("foUpperBounds")); // default to -Infinity
