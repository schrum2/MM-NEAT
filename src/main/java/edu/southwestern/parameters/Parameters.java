...
public class Parameters {
	...
	public final void fillDefaults() {
		...
		stringOptions.add("LodeRunnerGANModel", "LodeRunnerEpochAllGroundFirstTwenty10000_20_7.pth", "File name of GAN model to use for LodeRunner GAN level evolution");
		// Class options
