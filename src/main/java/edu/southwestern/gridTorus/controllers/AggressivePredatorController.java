...
public class AggressivePredatorController extends TorusPredPreyController {
	...
	@Override
	/**
	 * The getAction method takes in the controlled agent, the world and all
	 * predators and prey as arrays The closest prey is chosen and the
	 * TorusAgent moves towards this prey.
	 */
