...
public class LatentVariablePartitionSumBinLabels extends MultiDimensionalRealValuedSlicedBinLabels {
	 ...
	 * minPossibleValue 	-1 divided by the number of slices
	 * maxPossibleValue 	1 divided by the number of slices
