 ...
 * amount. Negative turns correspond to turning left, and positive turns to
 * turning right. The Tuple2D is used to store the data, but this class is a
 * facade that uses appropriate names to access the data in the tuple.
 *
 * @author Jacob Schrum
 */
public class Breve2DAction extends Tuple2D {
	...
	/**
	 * Create breve action from tuple. Interpret x as turn amount, and y as
	 * force amount.
	 * 
	 * @param tuple
	 */
