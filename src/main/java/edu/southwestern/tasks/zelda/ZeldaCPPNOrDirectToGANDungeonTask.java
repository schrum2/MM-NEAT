...
public class ZeldaCPPNOrDirectToGANDungeonTask extends ZeldaDungeonTask {
	...
	public static void main(String[] args) throws FileNotFoundException, NoSuchMethodException{
		MMNEAT.main("runNumber:0 randomSeed:0 zeldaDungeonDistanceFitness:true zeldaCPPNtoGANAllowsPuzzleDoors:true zeldaCPPNtoGANAllowsRaft:true zeldaDungeonDistinctRoomFitness:true zeldaDungeonBackTrackRoomFitness:true zeldaDungeonFewRoomFitness:false zeldaDungeonTraversedRoomFitness:false zeldaDungeonRandomFitness:false watch:true trials:1 mu:10 makeZeldaLevelsPlayable:false base:zeldacppnthendirect log:ZeldaCPPNThenDirect-NewMAPElites saveTo:NewMAPElites zeldaGANLevelWidthChunks:5 zeldaGANLevelHeightChunks:5 zeldaGANModel:ZeldaFixedDungeonsAll_5000_10.pth maxGens:500 io:true netio:true GANInputSize:10 mating:true fs:false task:edu.southwestern.tasks.zelda.ZeldaCPPNOrDirectToGANDungeonTask cleanOldNetworks:false zeldaGANUsesOriginalEncoding:false cleanFrequency:-1 saveAllChampions:true indirectToDirectTransitionRate:0.0 genotype:edu.southwestern.evolution.genotypes.CPPNOrDirectToGANGenotype netChangeActivationRate:0.3".split(" "));
//		try {
