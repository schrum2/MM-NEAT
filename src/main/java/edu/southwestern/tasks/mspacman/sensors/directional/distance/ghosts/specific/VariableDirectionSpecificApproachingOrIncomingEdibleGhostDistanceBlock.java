 ...
 * @author Jacob Schrum
 */
public class VariableDirectionSpecificApproachingOrIncomingEdibleGhostDistanceBlock
		extends VariableDirectionDistanceBlock {
	...
	public int[] getTargets(GameFacade gf) {
		if (gf.isGhostEdible(ghostIndex)
				&& (gf.ghostApproachingPacman(ghostIndex) || gf.isGhostIncoming(dir, ghostIndex))) {
