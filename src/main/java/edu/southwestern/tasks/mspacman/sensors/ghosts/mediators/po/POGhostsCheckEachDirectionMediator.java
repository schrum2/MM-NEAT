package edu.southwestern.tasks.mspacman.sensors.ghosts.mediators.po;
 ...
 * @author Jacob Schrum
 */
public class POGhostsCheckEachDirectionMediator extends VariableDirectionGhostBlockLoadedInputOutputMediator {

	public POGhostsCheckEachDirectionMediator() {
