...
public class PillTaskMediator extends UnionInputOutputMediator {
	...
	public PillTaskMediator() {
		this(Parameters.parameters.booleanParameter("absolute"), Parameters.parameters.booleanParameter("prox"),
				Parameters.parameters.booleanParameter("diff"), Parameters.parameters.booleanParameter("sim"),
				...
				Parameters.parameters.booleanParameter("lairDis"), Parameters.parameters.booleanParameter("veryClose"),
				Parameters.parameters.booleanParameter("mazeTime"),
				Parameters.parameters.booleanParameter("staticLookAhead"));
	}

	public PillTaskMediator(boolean absolute, boolean prox, boolean diff, boolean sim, boolean nearestDir,
			boolean nearestDis, boolean farthestDis, boolean lairDis, boolean veryClose, boolean mazeTime,
			boolean staticLookAhead) {
		super(mediators(absolute, prox, diff, sim, nearestDir, nearestDis, farthestDis, lairDis, veryClose, mazeTime,
				staticLookAhead));
	}

	public static ArrayList<BlockLoadedInputOutputMediator> mediators(boolean absolute, boolean prox, boolean diff,
			boolean sim, boolean nearestDir, boolean nearestDis, boolean farthestDis, boolean lairDis,
			boolean veryClose, boolean mazeTime, boolean staticLookAhead) {
