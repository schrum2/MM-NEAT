...
public class SubNetworkBlock<T extends Network> extends MsPacManSensorBlock {
	...
	public SubNetworkBlock(Network n, MsPacManControllerInputOutputMediator subnetMediator, String name,
	...
	public boolean equals(MsPacManSensorBlock o) {
		if (o != null && o.getClass() == this.getClass()) {
			...
			return other.name.equals(this.name) && other.includeInputs == this.includeInputs
					&& this.subnetMediator.getClass() == other.subnetMediator.getClass();
		}
		return false;
	}
