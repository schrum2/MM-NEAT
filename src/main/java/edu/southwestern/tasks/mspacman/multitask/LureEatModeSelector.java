...
/**
 * A Mode selector which extends the AnyGhostEdibleModeSelector, which selects
 * modes based on if there are any edible ghosts at all or not
 * 
 * @author Jacob Schrum
 */
public class LureEatModeSelector extends AnyGhostEdibleModeSelector {
	 ...
	 *         index based off of the luring fitness score and the score for
	 *         some edible ghosts in the second index
	 */
