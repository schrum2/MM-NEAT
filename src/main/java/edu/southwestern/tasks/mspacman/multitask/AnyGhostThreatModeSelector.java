...
/**
 * A Mode selector which selects modes based on if all the ghosts are edible or
 * if there are some threatening ghosts currently in the game
 * 
 * @author Jacob Schrum
 */
public class AnyGhostThreatModeSelector extends MsPacManModeSelector {
	...
	/**
	 * sets the game mode based on if there are some threatening ghosts or not 0
	 * if there are no threatening ghosts 1 if there are some threatening ghosts
	 * 
	 * @return mode
	 */
	public int mode() {
	 ...
	 * 
	 * @return an int array holding the score for if there are some threatening
	 *         ghosts in the first index and the score for if there are no
	 *         threatening ghosts in the second index
	 */
