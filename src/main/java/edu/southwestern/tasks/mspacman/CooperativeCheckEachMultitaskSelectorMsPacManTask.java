...
/**
 * Two networks are coevolved: One is a multitask network, the other is a
 * preference network. The preference network determines which multitask mode is
 * used at each time step. Additionally, the networks are "check-each" networks,
