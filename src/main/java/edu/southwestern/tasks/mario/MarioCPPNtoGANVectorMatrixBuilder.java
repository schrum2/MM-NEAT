 ...
 *
 */
public class MarioCPPNtoGANVectorMatrixBuilder implements MarioGANVectorMatrixBuilder {
	 ...
	 */
	public MarioCPPNtoGANVectorMatrixBuilder(Network cppn, double[] inputMultipliers) {
		this.cppn = cppn;
		this.inputMultipliers = inputMultipliers; // weights associated with different inputs to the CPPN
		
		Parameters.parameters.setInteger("cppn2ganWidth", Parameters.parameters.integerParameter("marioGANLevelChunks"));
		//Parameters.parameters.setInteger("cppn2ganHeight", Parameters.parameters.integerParameter("marioInputHeight"));
