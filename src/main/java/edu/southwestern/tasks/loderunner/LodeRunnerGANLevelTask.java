...
public class LodeRunnerGANLevelTask extends LodeRunnerLevelTask<List<Double>> {
	...
	public static void main(String[] args) {
		try {
			...
			//with MAPElites
			MMNEAT.main(new String[] {"runNumber:0", "randomSeed:0", "base:loderunnerlevelsMAPElites", "mapElitesBinLabels:edu.southwestern.tasks.loderunner.LodeRunnerMAPElitesPercentConnectedGroundAndLaddersBinLabels", "log:LodeRunnerLevels-Direct", "saveTo:Direct", "LodeRunnerGANModel:LodeRunnerEpochAllGroundFirstHundred100000_20_7.pth", "ea:edu.southwestern.evolution.mapelites.MAPElites", "experiment:edu.southwestern.experiment.evolution.SteadyStateExperiment","watch:false", "GANInputSize:20", "trials:1", "mu:100", "maxGens:100000", "io:true", "netio:true", "genotype:edu.southwestern.evolution.genotypes.BoundedRealValuedGenotype", "mating:true", "fs:false", "task:edu.southwestern.tasks.loderunner.LodeRunnerGANLevelTask", "cleanFrequency:-1", "saveAllChampions:true", "cleanOldNetworks:false", "logTWEANNData:false", "logMutationAndLineage:false", "steadyStateIndividualsPerGeneration:100", "aStarSearchBudget:100000"});
