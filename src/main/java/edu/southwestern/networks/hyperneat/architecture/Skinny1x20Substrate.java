...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected to a 1x20 second hidden with full. Last hidden connected to output with full
 * @author Devon Fulcher
 */
public class Skinny1x20Substrate implements SubstrateArchitectureDefinition{
