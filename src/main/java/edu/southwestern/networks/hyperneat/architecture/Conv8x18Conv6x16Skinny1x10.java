...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected with a 3x3 receptive field to the second hidden layer
 * Second hidden layer fully connected to the 1x10 third hidden.
 * @author Devon Fulcher
 */
public class Conv8x18Conv6x16Skinny1x10 implements SubstrateArchitectureDefinition{
	...
	public List<SubstrateConnectivity> getSubstrateConnectivity(HyperNEATTask hnt) {
		...
		FlexibleSubstrateArchitecture.connectHiddenToHidden(substrateConnectivity, networkHiddenArchitecture, 3, 3, 0, 1);
		FlexibleSubstrateArchitecture.connectHiddenToHidden(substrateConnectivity, networkHiddenArchitecture, -1, -1, 1, 0);
