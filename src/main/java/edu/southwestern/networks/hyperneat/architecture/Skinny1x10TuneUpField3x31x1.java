...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected to a 1x10 second hidden with 1x1 receptive field. Last hidden connected to output with full
 * @author Devon Fulcher
 */
public class Skinny1x10TuneUpField3x31x1 implements SubstrateArchitectureDefinition{
