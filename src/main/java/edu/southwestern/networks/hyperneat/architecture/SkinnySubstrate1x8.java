...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected to a 1x8 second hidden with full. Last hidden connected to output with full
 * @author Devon Fulcher
 */
public class SkinnySubstrate1x8 implements SubstrateArchitectureDefinition{
	...
	public List<Triple<Integer, Integer, Integer>> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new Triple<Integer, Integer, Integer>(1, 8, 1));
