...
/**
 * Inputs are connected to the first hidden layer by a 3x3 receptive field and the first hidden layer is fully connected to the second 1x10 hidden layer.
 * @author Devon Fulcher
 */
public class SuccessfulCombo implements SubstrateArchitectureDefinition{
