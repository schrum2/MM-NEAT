 ...
 * by a 20x3 receptive field.
 * @author Devon Fulcher
 */
public class HorizontalScanner20x3 implements SubstrateArchitectureDefinition{
	...
	public List<Triple<Integer, Integer, Integer>> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new Triple<Integer, Integer, Integer>(1, 6, 1));
	...
	public List<SubstrateConnectivity> getSubstrateConnectivity(HyperNEATTask hnt) {
		...
		FlexibleSubstrateArchitecture.connectAllAdjacentHiddenLayers(substrateConnectivity, networkHiddenArchitecture, 20, 3);
