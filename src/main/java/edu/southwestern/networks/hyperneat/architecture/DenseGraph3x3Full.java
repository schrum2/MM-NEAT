 ...
 * are connected to the first hidden layer by a 3x3 receptive field and the first hidden layer is fully connected to the second hidden layer.
 * @author Devon Fulcher
 */
public class DenseGraph3x3Full implements SubstrateArchitectureDefinition{
