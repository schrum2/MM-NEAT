 ...
 * the second hidden layer to the third hidden layer is 1x1, and the connection from 
 * the third hidden layer to the fourth hidden layer is 1x1
 * @author Devon Fulcher
 */
public class TuneUp3x31x11x11x1 implements SubstrateArchitectureDefinition{
