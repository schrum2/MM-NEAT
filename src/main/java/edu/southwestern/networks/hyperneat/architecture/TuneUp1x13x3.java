...
/**
 * D2W1 convolutional architecture where the connection from the input to the first hidden layer is 1x1 and
 * the connection from the first hidden layer to the second hidden layer is 3x3
 * @author Devon Fulcher
 */
public class TuneUp1x13x3 implements SubstrateArchitectureDefinition{
	...
	public List<SubstrateConnectivity> getSubstrateConnectivity(HyperNEATTask hnt) {
		...
		FlexibleSubstrateArchitecture.connectInputToFirstHidden(substrateConnectivity, io.t1, networkHiddenArchitecture, 1, 1);
