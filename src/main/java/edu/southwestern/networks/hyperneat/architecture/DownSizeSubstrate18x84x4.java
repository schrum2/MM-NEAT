...
/**
 * Inputs are connected to the first hidden layer by a 3x3 receptive field and the first hidden layer is fully connected to the second 4x4 hidden layer.
 * @author Devon Fulcher
 */
public class DownSizeSubstrate18x84x4 implements SubstrateArchitectureDefinition{
	...
	public List<Triple<Integer, Integer, Integer>> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new Triple<Integer, Integer, Integer>(1, 4, 4));
