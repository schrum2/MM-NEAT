...
/**
 * Inputs are connected to the first hidden layer and the second hidden layer by a 3x3 receptive field. The first hidden layer is connected to 
 * the second hidden layer by a 1x1 receptive field.
 * @author Devon Fulcher
 */
public class SkipToHidden implements SubstrateArchitectureDefinition{
