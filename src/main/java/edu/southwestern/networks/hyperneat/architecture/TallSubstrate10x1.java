...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected to a 10x1 second hidden with full. Last hidden connected to output with full
 * @author Devon Fulcher
 */
public class TallSubstrate10x1 implements SubstrateArchitectureDefinition{
	...
	public List<Triple<Integer, Integer, Integer>> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new Triple<Integer, Integer, Integer>(1, 1, 10));
