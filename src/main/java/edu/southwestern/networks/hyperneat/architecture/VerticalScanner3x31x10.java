...
/**
 * Inputs are connected to the first hidden layer by a 3x3 receptive field and the first hidden layer is connected to the second hidden layer
 * by a 1x10 receptive field.
 * @author Devon Fulcher
 */
public class VerticalScanner3x31x10 implements SubstrateArchitectureDefinition{
	...
	public List<Triple<Integer, Integer, Integer>> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new Triple<Integer, Integer, Integer>(1, 1, 18));
	...
	public List<SubstrateConnectivity> getSubstrateConnectivity(HyperNEATTask hnt) {
		...
		FlexibleSubstrateArchitecture.connectAllAdjacentHiddenLayers(substrateConnectivity, networkHiddenArchitecture, 10, 1);
