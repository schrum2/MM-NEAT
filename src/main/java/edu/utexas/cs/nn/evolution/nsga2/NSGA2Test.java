...
public class NSGA2Test {
	...
	public void testSelection() {
		...
		assertTrue(ArrayUtil.setEquality(PopulationUtil.getGenotypeIds(PopulationUtil.addListGenotypeType(result0)),
				fronts.get(0)));
		ArrayList<Genotype> result1 = ea.selection(6, scores);
		fronts.get(1).addAll(fronts.get(0));
		assertTrue(ArrayUtil.setEquality(PopulationUtil.getGenotypeIds(PopulationUtil.addListGenotypeType(result1)),
				fronts.get(1)));
		ArrayList<Genotype> result2 = ea.selection(9, scores);
		fronts.get(2).addAll(fronts.get(1));
		assertTrue(ArrayUtil.setEquality(PopulationUtil.getGenotypeIds(PopulationUtil.addListGenotypeType(result2)),
				fronts.get(2)));
	}
}
