 ...
 * @author Jacob Schrum
 */
public class VariableDirectionCloserToDepthTwoJunctionThanThreatGhostBlock
	...
	public int[] getTargets(GameFacade gf) {
		...
		// Lazy method: Targets actually include depth 3, 4, etc junctions as
		// well
		...
		// gf.addPoints(dir == 0 ? Color.WHITE : (dir == 1 ? Color.GRAY : (dir
		// == 2 ? Color.YELLOW : Color.PINK)), result);
		// }
		return result;
	}
}
