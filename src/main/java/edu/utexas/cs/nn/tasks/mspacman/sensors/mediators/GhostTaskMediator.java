...
public class GhostTaskMediator extends UnionInputOutputMediator {
	...
	public GhostTaskMediator(boolean senseEdibleGhosts) {
		this(senseEdibleGhosts, Parameters.parameters.booleanParameter("absolute"),
				Parameters.parameters.booleanParameter("prox"), Parameters.parameters.booleanParameter("diff"),
				Parameters.parameters.booleanParameter("sim"), Parameters.parameters.booleanParameter("cluster"),
				...
				Parameters.parameters.booleanParameter("ghostTimes"), Parameters.parameters.booleanParameter("lairDis"),
				Parameters.parameters.booleanParameter("veryClose"), Parameters.parameters.booleanParameter("mazeTime"),
				Parameters.parameters.booleanParameter("incoming"),
				Parameters.parameters.booleanParameter("staticLookAhead"));
	}

	public GhostTaskMediator(boolean senseEdibleGhosts, boolean absolute, boolean prox, boolean diff, boolean sim,
			boolean cluster, boolean nearestDir, boolean nearestDis, boolean farthestDis, boolean specific,
			boolean specialPowerPill, boolean ghostTimes, boolean lairDis, boolean veryClose, boolean mazeTime,
			boolean incoming, boolean staticLookAhead) {
		super(mediators(senseEdibleGhosts, absolute, prox, diff, sim, cluster, nearestDir, nearestDis, farthestDis,
				specific, specialPowerPill, ghostTimes, lairDis, veryClose, mazeTime, incoming, staticLookAhead));
	}

	public static ArrayList<BlockLoadedInputOutputMediator> mediators(boolean senseEdibleGhosts, boolean absolute,
			boolean prox, boolean diff, boolean sim, boolean cluster, boolean nearestDir, boolean nearestDis,
			boolean farthestDis, boolean specific, boolean specialPowerPill, boolean ghostTimes, boolean lairDis,
			boolean veryClose, boolean mazeTime, boolean incoming, boolean staticLookAhead) {
