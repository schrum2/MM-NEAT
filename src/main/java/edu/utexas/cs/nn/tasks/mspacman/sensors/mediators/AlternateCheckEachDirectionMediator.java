 ...
 * @author Jacob Schrum
 */
public class AlternateCheckEachDirectionMediator extends VariableDirectionBlockLoadedInputOutputMediator {

	public AlternateCheckEachDirectionMediator() {
		this(-1); // direction irrelevant
	}

	public AlternateCheckEachDirectionMediator(int direction) {
		...
		blocks.add(new VariableDirectionCloserToEdibleGhostThanThreatGhostBlock(direction)); // Does
																								// not
																								// account
																								// for
																								// edible
