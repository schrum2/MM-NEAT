 ...
 */
@AgentScoped
public class HowMuchCanThisBeMessedWith extends UT2004BotModuleController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
        ...
        return new Initialize().setName("CrazyTown-" + (++instanceCount)).setDesiredSkill(5);
    }
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(HowMuchCanThisBeMessedWith.class, "Hunter").setMain(true).setLogLevel(Level.INFO).startAgents(2);
    }
}
