...
package micro.ai.ahtn.planner;

import micro.ai.HasEvaluationFunction;
import micro.ai.ahtn.domain.Binding;
 ...
 *
 * @author santi
 * this code too broken/unfinished to be used in experiments -Alice
 */
public class AdversarialBoundedDepthPlannerAlphaBeta implements HasEvaluationFunction{
