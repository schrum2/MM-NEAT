...
public class PuddleWorld extends RLGlueEnvironment
	...
	public TaskSpec makeTaskSpec() {
		...
		theTaskSpecObject
				.addContinuousObservation(new DoubleRange(theState.worldRect.getMinX(), theState.worldRect.getMaxX()));
		theTaskSpecObject
				.addContinuousObservation(new DoubleRange(theState.worldRect.getMinY(), theState.worldRect.getMaxY()));

		theTaskSpecObject.addDiscreteAction(new IntRange(0, 3));
		theTaskSpecObject.setRewardRange(new DoubleRange(-80, 0));
		theTaskSpecObject
				.setExtra("EnvName:Puddle-World Revision:" + this.getClass().getPackage().getImplementationVersion());
	...
	public String env_message(String theMessage) {
		...
		System.err.println(
				"We need some code written in Env Message for PuddleWorld.. unknown request received: " + theMessage);
		Thread.dumpStack();
		return null;
	}
