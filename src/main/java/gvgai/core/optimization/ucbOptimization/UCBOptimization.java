package gvgai.core.optimization.ucbOptimization;
...
public class UCBOptimization implements OptimizationObjective {
	...
	gvgai.tracks.singlePlayer.tools.ucbOptimizerAgent.Agent.ucb = ucb;
    }
	...
	return gvgai.tracks.singlePlayer.tools.ucbOptimizerAgent.Agent.ucb.lengthParameters();
    }
	...
	gvgai.tracks.singlePlayer.tools.ucbOptimizerAgent.Agent.parameters = parameters;
