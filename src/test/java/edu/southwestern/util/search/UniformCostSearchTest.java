...
/**
 * Basically a copy of AStarSearchTest, but testing UniformCostSearch.
 * They return the same answers ... A* is just more efficient.
 * @author schrum2
 *
 */
public class UniformCostSearchTest {
	...
	public void simpleGridWorldTest() {
		Search<GridAction,GridState> search = new UniformCostSearch<>();
