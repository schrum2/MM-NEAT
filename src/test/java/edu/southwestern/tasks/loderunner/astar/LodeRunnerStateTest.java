...
public class LodeRunnerStateTest {
	...
	public static final int LODE_RUNNER_LEVEL_1_ACTION_LENGTH = 110;
	...
	public void testLodeRunnerAStarPath() {
		...
		LodeRunnerState start1 = new LodeRunnerState(level1,true);
		...
		LodeRunnerState start2 = new LodeRunnerState(level2,true);
