...
public class GaierAutoencoderNeuronLossScaleRotationDeltaXDeltaYBinLabelsTest {
	...
	public void setUp() throws Exception {
		Parameters.initializeParameterCollections(new String[] {"maxNumNeurons:100", "numScaleIntervals:10", "numRotationIntervals:10", "numTranslationIntervals:10", "maxScale:50", "trainingAutoEncoder:true"});
