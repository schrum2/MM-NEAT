...
The code was developed by Jacob Schrum (schrum2@cs.utexas.edu) while at the University
of Texas at Austin. Links to publications and demos further explaining the code
are available at the official webpage:
...
the Ms. Pac-Man vs. Ghosts Competitions, which can be downloaded in its original
