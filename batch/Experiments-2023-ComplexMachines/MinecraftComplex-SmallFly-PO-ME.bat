...
minecraftAccumulateChangeInCenterOfMass:true minecraftChangeCenterOfMassFitness:true base:minecraftcomplex log:MinecraftComplex-SmallFlyPOME saveTo:SmallFlyPOME
