...
changeCenterOfMassFiltersBlocks:true ^
...
minecraftWeightedSumsMissileAndChangeCenterOfMassFitness:false ^
minecraftSequentialChangeCenterOfMassThenMissileFitness:true ^
mapElitesSoftAnnealingArchive:true mapAnnealingAlpha:0.5 ^
...
base:minecraftcomplex log:MinecraftComplex-MissilePOSoftSeqFlyTNTThenMissile saveTo:MissilePOSoftSeqFlyTNTThenMissile
