...
REM May need to adjust resolution for particular system
ffmpeg -f gdigrab -framerate 30 -offset_x 0 -offset_y 0 -video_size 1280x768 -show_region 1 -i desktop %1.mkv
