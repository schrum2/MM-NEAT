...
java -ea -jar "target/MM-NEAT-0.0.1-SNAPSHOT.jar" minecraftEvaluate minecraftBlockListTextFile:%1 netio:false spaceBetweenMinecraftShapes:10 minecraftWaterLavaSecondaryCreationFitness:true