# Usage:   postBestFourMazeRecord.bat <experiment directory> <log prefix> <run type> <run number> <recording save file>
# Example: postBestFourMazeRecord.bat onelifeconflict OneLifeConflict OneModule 0 OneLifeConflict-OneModule0.rec
