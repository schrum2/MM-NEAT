...
SoundRemixer (prototype)
*MM-NEAT/src/main/java/edu/southwestern/tasks/interactive/remixbreeder/SoundRemixTask.java
...
sound in this way.
*Developed using MM-NEAT ... still under development.

PictureRemixer (prototype)
*MM-NEAT/src/main/java/edu/southwestern/tasks/interactive/remixbreeder/PictureRemixTask.java
*PictureRemixer manipulates images by taking in an x-coordinate, a y-coordinate, the distance from the center,
the input picture's HSB, and a bias of 1.0 as inputs to the CPPN, and outputting hue, saturation, and 
